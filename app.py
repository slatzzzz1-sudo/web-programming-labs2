...
if app.config['DB_TYPE'] == 'postgres':
    db_name = 'dima_samoylov_orm'
    db_user = 'dima_samoylov_orm'
    db_password = '123'
    host_ip = '127.0.0.1'
    host_port = 5432
    ...
    db_path = path.join(dir_path, "dima_samoylov_orm.db")
        ...
        <html>
            ...
            <body>
                ...
                <ul>
                    ...
                    <li><a href="/lab9">Девятая лабораторная 9</a><li>
                </ul>
                <hr>
                <footer>
                    Самойлов Дмитрий Алексеевич, ФБИ-322, 3 курс, 2025
                </footer>
            </body>
        </html>'''
